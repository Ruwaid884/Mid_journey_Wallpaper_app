...
import com.example.uidesignwallpapers.images
import kotlin.math.min

class special_recycler(private val images:List<Image>,private val context: Context): RecyclerView.Adapter<special_recycler.MyViewHolder>() {
    ...
    val image1:ImageView = itemView.findViewById(R.id.special_image1)

        val image2:ImageView = itemView.findViewById(R.id.special_image2)

        val image3:ImageView = itemView.findViewById(R.id.special_image3)

    }


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.special_recycler,
            parent,false)
